macro(GET_OS_INFO)
    ...
    set(VTOOL_LIB_INSTALL_DIR "lib${LIB_SUFFIX}")
    set(VTOOL_INCLUDE_INSTALL_DIR
        "include/${PROJECT_NAME_LOWER}-${VTOOL_MAJOR_VERSION}.${VTOOL_MINOR_VERSION}")
...
macro(DISSECT_VERSION)
    ...
    string(REGEX REPLACE "^([0-9]+).*" "\\1"
        VTOOL_IBEIS_VERSION_MAJOR "${VTOOL_IBEIS_VERSION}")
    string(REGEX REPLACE "^[0-9]+\\.([0-9]+).*" "\\1"
        VTOOL_IBEIS_VERSION_MINOR "${VTOOL_IBEIS_VERSION}")
    string(REGEX REPLACE "^[0-9]+\\.[0-9]+\\.([0-9]+)" "\\1"
        VTOOL_IBEIS_VERSION_PATCH ${VTOOL_IBEIS_VERSION})
    string(REGEX REPLACE "^[0-9]+\\.[0-9]+\\.[0-9]+(.*)" "\\1"
        VTOOL_IBEIS_VERSION_CANDIDATE ${VTOOL_IBEIS_VERSION})
    set(VTOOL_SOVERSION "${VTOOL_IBEIS_VERSION_MAJOR}.${VTOOL_IBEIS_VERSION_MINOR}")
