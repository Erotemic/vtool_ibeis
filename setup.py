...
if __name__ == '__main__':
    ...
    setupkw['extras_require'] = {
        ...
        # 'headless': parse_requirements('requirements/headless.txt'),  # vtool_ibeis: +UNCOMMENT_IF(cv2)
        # 'graphics': parse_requirements('requirements/graphics.txt'),  # vtool_ibeis: +UNCOMMENT_IF(cv2)
        # Strict versions
        # 'headless-strict': parse_requirements('requirements/headless.txt', versions='strict'),  # vtool_ibeis: +UNCOMMENT_IF(cv2)
        # 'graphics-strict': parse_requirements('requirements/graphics.txt', versions='strict'),  # vtool_ibeis: +UNCOMMENT_IF(cv2)
