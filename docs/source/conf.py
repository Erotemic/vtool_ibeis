...
Notes:
    ...
    sphinx-apidoc -f -o ~/code/vtool_ibeis/docs/source ~/code/vtool_ibeis/vtool_ibeis --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/vtool_ibeis/advanced/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/vtool_ibeis/versions/
"""
#
...
htmlhelp_basename = 'vtool_ibeisdoc'
