...
Notes:
    ...
    rm -rf ~/code/vtool_ibeis/docs/source/auto
    cd ~/code/vtool_ibeis/docs
    sphinx-apidoc --private --separate --force --output-dir ~/code/vtool_ibeis/docs/source/auto ~/code/vtool_ibeis/vtool_ibeis
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/vtool-ibeis/advanced/
        ...
        Enter the following information:
            Set the Repository NAME: vtool_ibeis
            Set the Repository URL: https://github.com/Erotemic/vtool_ibeis

        Make sure you have a .readthedocs.yml file

        For gitlab you also need to setup an integrations. Navigate to:

            https://readthedocs.org/dashboard/vtool-ibeis/integrations/create/
        ...
        Then go to
            ...
            https://github.com/Erotemic/vtool_ibeis/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/vtool-ibeis/versions/
"""
#
...
project = 'vtool_ibeis'
copyright = '2026, Jon Crall Jason Parham Hendrik Weideman Avi Weinstock Zackary Rutfield Chuck Stewart'
author = 'Jon Crall Jason Parham Hendrik Weideman Avi Weinstock Zackary Rutfield Chuck Stewart'
modname = 'vtool_ibeis'

repo_dpath = dirname(dirname(dirname(__file__)))
mod_dpath = join(repo_dpath, 'vtool_ibeis')
...
# html_logo = '.static/vtool_ibeis.svg'
# html_favicon = '.static/vtool_ibeis.ico'
...
latex_documents = [
    (master_doc, 'vtool_ibeis.tex', 'vtool_ibeis Documentation',
     'Jon Crall Jason Parham Hendrik Weideman Avi Weinstock Zackary Rutfield Chuck Stewart', 'manual'),
]
...
man_pages = [
    (master_doc, 'vtool_ibeis', 'vtool_ibeis Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'vtool_ibeis', 'vtool_ibeis Documentation',
     author, 'vtool_ibeis', 'One line description of project.',
     'Miscellaneous'),
]
